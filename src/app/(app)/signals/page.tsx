  ...
  return (
    <div>
      <PageHeader
        ...
        title="Signals"
        description="Deduplicated commercial signals across the monitored oncology universe, ranked by deterministic opportunity score. Fact, inference and recommendation stay separate on every entry."
      />
      {signals.length === 0 ? (
        <EmptyState
